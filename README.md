...
- **Execute autonomously** using the OODA loop (Observe-Orient-Decide-Act)
- **Learn over time** with a three-tier memory system
...
2. **ORIENT** - Understand: What should I do? What has been done? What should I not do?
3. **DECIDE** - Plan: Write a to-do list, create a plan file (crash recovery mechanism)
4. **ACT** - Execute: Do the work, consolidate memory, commit to git, schedule next wake

### Memory System

Three-tier memory with clear separation:
...
| File | Purpose |
|------|---------|
| `claude.md` | OODA loop execution instructions - the agent's core |
